    ...
    <footer style={{
      ...
      <div style={{ maxWidth: 1160, margin: '0 auto', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 20 }}>
        <Link to="/" style={{ display: 'flex', alignItems: 'center', gap: 9, textDecoration: 'none' }}>
          <div style={{ width: 28, height: 28, borderRadius: 6, background: '#1B2559', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          ...
          <span style={{ fontWeight: 700, fontSize: 15, color: '#1B2559', letterSpacing: '-0.01em' }}>ORVN Labs</span>
        </Link>
